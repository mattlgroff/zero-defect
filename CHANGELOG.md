...
- The marketplace and packaged plugin versions are now `1.1.0`.
- Installation documentation now names the future `zero-defect-1.1.0.zip` release asset.
...
[1.1.0]: https://github.com/mattlgroff/zero-defect/compare/v1.0.0...v1.1.0
