...
description: Internal Zero Defect consistency lens. Use only when the zero-defect skill explicitly dispatches this named reviewer as part of the complete eight-lens review.
